...
@section('content')
	<div class="container mt-5 mb-3">
		<div class="card shadow p-3 mb-5 bg-white rounded">
			<h4>More Detail</h4>
			<hr>
			<form action="{{ route('fill_js') }}" method="post" enctype="multipart/form-data">
				@csrf
				...
				<div class="form-group row {{ $errors->has('dob') ? 'has-error' : '' }}">
					<label for="inputDob" class="col-md-5 col-form-label">Date of Birth</label>
					<div class="col-md-3">
