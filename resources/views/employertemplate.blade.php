	    ...
	    <div class="container-fluid px-md-4	">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item"><a href="#" class="nav-link">Search CVs</a></li>
	          @guest
          <li class="nav-item">
            <a class="nav-link" href="{{ route('emplogin') }}">{{ __('Sign in') }}</a>
          </li>
          @if(Route::has('register'))
          <li class="nav-item">
            <a class="nav-link" href="{{ route('empreg') }}">{{ __('Register') }}</a>
          </li>
          <li class="nav-item">
            <a class="nav-link btn btn-primary text-light" href="{{ route('jslogin') }}">For JobSeeker</a>
          </li>
          @endif
          @else
