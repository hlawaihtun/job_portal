...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('jobvacancies.index') }}">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{ route('jsexperiences.index') }}">
          <i class="fas fa-briefcase"></i>
          <span>Experiences</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{ route('jseducations.index') }}">
          <i class="fas fa-graduation-cap"></i>
          <span>Educations</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{ route('jsskills.index') }}">
          <i class="fas fa-graduation-cap"></i>
          <span>Skills</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{ route('jslanguages.index') }}">
          <i class="fas fa-graduation-cap"></i>
