		...
		<div class="card shadow p-3 mb-5 bg-white rounded detail">
			...
			<form action="{{ route('jobvacancies.store') }}" method="post">
				...
				<div class="form-group row mt-5 {{ $errors->has('title') ? 'has-error' : '' }}">
					...
					<div class="col-md-5">
						<input type="text" id="inputTitle" name="title" class="d-block form-control">
				...
				<div class="form-group row {{ $errors->has('description') ? 'has-error' : '' }}">
					...
					<div class="col-md-5">
						<textarea type="text" id="inputDesc" name="description" class="form-control" rows="3"></textarea>
				...
				<div class="form-group row {{ $errors->has('apply') ? 'has-error' : '' }}">
					...
					<div class="col-md-5">
						<textarea type="text" id="inputApply" name="apply" class="form-control" rows="3"></textarea>
				...
				<div class="form-group row {{ $errors->has('request') ? 'has-error' : '' }}">
					...
					<div class="col-md-5">
						<textarea type="text" id="inputRequest" name="request" class="form-control" rows="3"></textarea>
				...
				<div class="form-group row {{ $errors->has('ladate') ? 'has-error' : '' }}">
					...
					<div class="col-md-3">
						<input type="date" id="inputLadate" name="ladate" class="form-control min-today" placeholder="YYY-MM-DD" data-date-split-input="true">
