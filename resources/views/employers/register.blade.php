            ...
            <div class="container sign_container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h3 class="form-title">Employer Sign up</h3>
                        <form method="POST" action="{{ url('empreg') }}" class="register-form" id="register-form">
                            @csrf
                    ...
                    <div class="signup-image">
                        ...
                        <a href="{{ route('emplogin') }}" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
        </section>
